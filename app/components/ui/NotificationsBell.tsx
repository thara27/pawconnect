  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative rounded-full border border-border bg-white p-2 text-ink shadow-sm transition hover:border-orange hover:bg-orange-light"
              ...
              {items.slice(0, 12).map((notification) => (
                <li
                  ...
                  className={`rounded-lg border px-3 py-2 ${
                    notification.is_read ? "border-border bg-white" : "border-orange bg-orange-light"
                  }`}
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {notification.booking_id && (
                        <Link
                          href="/dashboard"
                          className="mt-1 inline-block text-[11px] font-semibold text-orange hover:underline"
                        >
                          Open dashboard
                        </Link>
                      )}
